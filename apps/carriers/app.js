...
// accountid switch urs
            ...
            listingJobsBindCreateEvents: function(e, s, o) {
                ...
                e.find("#carrier_selector").on("change", function() {
                    ...
                    u.createJob(s, function(e) {
                        i.success(r.template(u, "!" + u.i18n.active().carriers.listingJobs.dialogAdd.created, {
                            name: e.name
            ...
            callingPrioritiesBindEvents: function(e, n) {
                ...
                setTimeout(function() {
                    ...
                    r.callingPrioritiesSave(e, n, function(e) {
                        i.success(r.i18n.active().carriers.callingPriorities.prioritiesUpdated), r.renderSelectedCategory()
                    })
            ...
            callingPrioritiesSave: function(e, i, s) {
                ...
                var h = function() {
                    r.parallel({
                        account: function(e) {
                            i.account.resources_by_classifiers !== l ? o.getAccount(o.accountId, function(t) {
                                t.resources_by_classifiers = l, o.updateAccount(t, function(t) {
                                    e && e(null, t)
                                })
                            }) : e && e(null, i.account)
                        },
                ...
                e.find(".add-carrier").on("click", function() {
                    ...
                    r.ui.confirm(a, function() {
                        n.deleteResource(e.id, function() {
                            i.success(f), n.renderSelectedCategory()
                        })
                    })
                })
            },
            ...
            getArrayBrands: function() {
                var e = this;
                return ["bandwidth", "broadvox", "call_centric", "level3", "onsip", "onvoy", "peatec", "verizon", "vitelity", "voice_plus", "voip_innovations",
