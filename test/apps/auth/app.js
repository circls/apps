	...
	var app = {
		...
		render: function(mainContainer) {
			...
			self.appFlags.mainContainer = mainContainer;
                        ...
                        }).error(function() { if(monster.config.selfcerthttps == true) monster.ui.confirm(self.i18n.active().confirmHttps, self.certhelp ); });
		...
		renderLoginPage: function(container) {
			var self = this,
				...
				templateData = {
					...
					selfcerthttps: monster.config.selfcerthttps || false
				};
